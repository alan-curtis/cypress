...
class Wf_Sn_Vu
{
    ...
    public static function get_options()
    {
        ...
        $options = get_option( WF_SN_VU_OPTIONS_KEY, array() );
    ...
    {
        register_setting( WF_SN_VU_OPTIONS_NAME, WF_SN_VU_OPTIONS_KEY, array( __CLASS__, 'sanitize_settings' ) );
    }
    ...
    */
    ...
    public static function render_vuln_page()
    {
        ...
        $wp_status = '';
        //$return_vulnerabilities = self::return_vulnerabilities();
        ?>
        ...
        if ( isset( $vulnerabilities['wordpress'] ) or isset( $vulnerabilities['plugins'] ) or isset( $vulnerabilities['themes'] ) ) {
            ...
            if ( isset( $vulnerabilities['wordpress'] ) ) {
                ...
                if ( '' !== $wp_status ) {
                    ?>
					<div class="vulnrecommendation"><h2>
					<?php 
                    echo  $wp_status ;
            ...
            if ( isset( $vulnerabilities['plugins'] ) ) {
                ...
                foreach ( $vulnerabilities['plugins'] as $key => $found_vuln ) {
                    ...
                    if ( isset( $found_vuln['versionEndExcluding'] ) ) {
                        ...
                        ?>
						<div class="vulnrecommendation"><p><a href="<?php 
                        ...
                        ?>
						<div class="vulnrecommendation"><p><strong><?php 
