...
if ( function_exists( 'secnin_fs' ) ) {
	...
	<p><small>This notice is shown every 30 days.</small></p>
        ...
        public static function is_plugin_page()
        {
            ...
            if ( in_array( $current_screen->id, array( 'toplevel_page_wf-sn' ), true ) || strpos( $current_screen->id, 'page_wf-sn-debug' ) !== false || strpos( $current_screen->id, 'page_wf-sn-tools' ) !== false || strpos( $current_screen->id, 'page_wf-sn-fixes' ) !== false ) {
                return true;
            } else {
                return false;
            }
