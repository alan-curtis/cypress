...
// Plugins
			...
			'application_passwords' => array(
				'title'   => __( 'Check if Application Passwords are enabled (New in WordPress 5.6)', 'security-ninja' ),
				'score'   => 2,
				'msg_ok'  => __( 'The Application Passwords feature is disabled.', 'security-ninja' ),
				'msg_bad' => __( 'The Application Passwords feature is enabled.', 'security-ninja' ),
			),
