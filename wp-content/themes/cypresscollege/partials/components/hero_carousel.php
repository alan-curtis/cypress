              ...
              <div class="owl-item">
                <img class="hero-image" src="<?php echo $carousel_image; ?>" alt="<?php echo $title?>" <?php echo $videoTagHeight?>>
                  <?php if($title !== '' || $description !== ''): ?>
                    <?php if($sliderUrl !== ''):?><a href="<?php echo $sliderUrl;?>"><?php endif; ?>

                    <?php if($title !== '' || $description !== ''): ?><div class="hero-content"><?php endif; ?>

                    <?php if($title !== '' ): ?><h1><?php echo $title?></h1><?php endif; ?>
                    <?php if($description !== ''): ?><div class="heading-five"><?php echo $description; ?></div><?php endif; ?>

                    <?php if($title !== '' || $description !== ''): ?></div><?php endif; ?>

                    <?php if($sliderUrl !== ''):?></a><?php endif;?>
                <?php endif;?>
              </div>
