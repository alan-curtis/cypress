<?php
// Breadcrumbs
function cypress_breadcrumbs()
{
// Get the query & post information
    global $post, $wp_query;

    // Settings
    $home_title = 'Cypress College Career Education';
    ...
    if (! is_front_page()) {
        ...
        if (is_archive() && ! is_tax() && ! is_category() && ! is_tag()) {
            ...
            if (is_archive() && is_tax() && ! is_category() && ! is_tag()) {
                ...
                if ($post_type && !in_array($post_type, ['post', 'program'])) {
                ...
                } elseif (($post_type == 'program') || (isset($uri_segments[0]) && $uri_segments[0] == 'department')){
                    echo '<span class="item-cat item-custom-post-type-'.$post_type.'"><a class="bread-cat bread-custom-post-type-'.$post_type.'" href="/cte-program-index/" title="Departments">Departments</a></span>';
                }
