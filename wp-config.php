...
if ( ! empty( $_ENV['PANTHEON_ENVIRONMENT'] ) ) {
  switch( $_ENV['PANTHEON_ENVIRONMENT'] ) {
    case 'live':
      ...
      define( 'DOMAIN_CURRENT_SITE', 'www.cypresscollege.edu' );
      // Once you map a domain to Live, you can change DOMAIN_CURRENT_SITE
      // define( 'DOMAIN_CURRENT_SITE', 'example-network.com' );
      break;
    case 'test':
      define( 'DOMAIN_CURRENT_SITE', 'cypress.staging-preview.com' );
      break;
    case 'dev':
      define( 'DOMAIN_CURRENT_SITE', 'cypress.development-preview.com' );
      break;
    default:
